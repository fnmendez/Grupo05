class DirectorsController < ApplicationController
  ...
  def create
    ...
    @chapter_directed.director = @director

    respond_to do |format|
      if @director.save && @chapter_directed.save
        format.html { redirect_to @chapter, notice: 'Director was successfully created.' }
  ...
  def destroy
    @director.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Director was successfully destroyed.' }
